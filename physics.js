...
function preload() {
  game.load.image('tetrisblock1', 'sprites/tetrisblock1.png');
  game.load.image('tetrisblock2', 'sprites/tetrisblock2.png');
  game.load.image('tetrisblock3', 'sprites/tetrisblock3.png');
...
function create() {
  ...
  var introText = game.add.text(game.world.centerX, 200, 'Click and drag blocks', { font: "40px ActionMan", fill: "#ffffff", align: "center" });
  ...
  game.physics.p2.createDistanceConstraint(tetris3, tetris2, 100);
